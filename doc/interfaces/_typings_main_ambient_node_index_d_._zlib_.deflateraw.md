...
### Constructors
* [constructor](_typings_main_ambient_node_index_d_._zlib_.deflateraw.md#constructor)

### Properties
* [readable](_typings_main_ambient_node_index_d_._zlib_.deflateraw.md#readable)
* [writable](_typings_main_ambient_node_index_d_._zlib_.deflateraw.md#writable)
* [EventEmitter](_typings_main_ambient_node_index_d_._zlib_.deflateraw.md#eventemitter)
* [defaultMaxListeners](_typings_main_ambient_node_index_d_._zlib_.deflateraw.md#defaultmaxlisteners)

### Methods
* [_flush](_typings_main_ambient_node_index_d_._zlib_.deflateraw.md#_flush)
* [_transform](_typings_main_ambient_node_index_d_._zlib_.deflateraw.md#_transform)
* [addListener](_typings_main_ambient_node_index_d_._zlib_.deflateraw.md#addlistener)
* [emit](_typings_main_ambient_node_index_d_._zlib_.deflateraw.md#emit)
* [end](_typings_main_ambient_node_index_d_._zlib_.deflateraw.md#end)
* [getMaxListeners](_typings_main_ambient_node_index_d_._zlib_.deflateraw.md#getmaxlisteners)
* [listenerCount](_typings_main_ambient_node_index_d_._zlib_.deflateraw.md#listenercount)
* [listeners](_typings_main_ambient_node_index_d_._zlib_.deflateraw.md#listeners)
* [on](_typings_main_ambient_node_index_d_._zlib_.deflateraw.md#on)
* [once](_typings_main_ambient_node_index_d_._zlib_.deflateraw.md#once)
* [pause](_typings_main_ambient_node_index_d_._zlib_.deflateraw.md#pause)
* [pipe](_typings_main_ambient_node_index_d_._zlib_.deflateraw.md#pipe)
* [push](_typings_main_ambient_node_index_d_._zlib_.deflateraw.md#push)
* [read](_typings_main_ambient_node_index_d_._zlib_.deflateraw.md#read)
* [removeAllListeners](_typings_main_ambient_node_index_d_._zlib_.deflateraw.md#removealllisteners)
* [removeListener](_typings_main_ambient_node_index_d_._zlib_.deflateraw.md#removelistener)
* [resume](_typings_main_ambient_node_index_d_._zlib_.deflateraw.md#resume)
* [setEncoding](_typings_main_ambient_node_index_d_._zlib_.deflateraw.md#setencoding)
* [setMaxListeners](_typings_main_ambient_node_index_d_._zlib_.deflateraw.md#setmaxlisteners)
* [unpipe](_typings_main_ambient_node_index_d_._zlib_.deflateraw.md#unpipe)
* [unshift](_typings_main_ambient_node_index_d_._zlib_.deflateraw.md#unshift)
* [wrap](_typings_main_ambient_node_index_d_._zlib_.deflateraw.md#wrap)
* [write](_typings_main_ambient_node_index_d_._zlib_.deflateraw.md#write)
* [listenerCount](_typings_main_ambient_node_index_d_._zlib_.deflateraw.md#listenercount-1)

## Constructors

### new DeflateRaw(opts?: [TransformOptions](_typings_main_ambient_node_index_d_._stream_.transformoptions.md)): [DeflateRaw](_typings_main_ambient_node_index_d_._zlib_.deflateraw.md)
...
#### Returns: [DeflateRaw](_typings_main_ambient_node_index_d_._zlib_.deflateraw.md)
